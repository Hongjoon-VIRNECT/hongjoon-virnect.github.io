(function () {
    ...
    function getAccAvailable() {
        if (accAvailable == null) {
            if ('Accelerometer' in window) {
                // The `Accelerometer` interface is supported by the browser.
                // Does the device have an accelerometer, though?
                accAvailable = "Acc is available!";
            }
            else {
                accAvailable = "Not available!";
            }
        }
        return accAvailable;
    }
    ...
    window.MobileDevice.getAccAvailable = getAccAvailable;
